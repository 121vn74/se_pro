                ...
                <div className="header-content">
                    <div className="header-left">
                        <Link to="/">
                            ...
                            <button className='clean-button text-light' onClick={() => { changeCategory("SmartPhones") }} style={{ marginRight: '10px' }}>SmartPhones</button>
                            <button className='clean-button text-light' onClick={() => { changeCategory("Smartwatches") }} style={{ marginRight: '10px' }}>Smartwatches</button>
                            <button className='clean-button text-light' onClick={() => { changeCategory("TWS") }} style={{ marginRight: '10px' }}>TWS</button>
                           
                            <button className='clean-button text-light' onClick={() => { changeCategory("Accessories") }}>Accessories</button>
