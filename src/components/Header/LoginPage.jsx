...
function LoginPage() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await fetch('http://localhost:3005/coachlog', {
        method: 'POST',
        headers: {
  ...
  const backgroundImageUrl='https://img.freepik.com/free-vector/hand-painted-watercolor-pastel-sky-background_23-2148902771.jpg';
  return (
